...
export const EnergyModal: React.FC<EnergyModalProps> = ({
  ...
  return (
    ...
    >
      <div className="w-full max-w-2xl glass-panel border border-white/10 rounded-3xl p-6 relative shadow-2xl overflow-hidden my-auto">
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-2 rounded-full bg-slate-900 border border-white/10 text-slate-400 hover:text-white hover:border-emerald-500/40 active:scale-95 transition-all cursor-pointer z-10"
          aria-label="Fermer"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="grid grid-cols-3 gap-3 mb-5 font-mono">
          <div className="p-3 rounded-xl bg-slate-900/80 border border-white/5">
            <div className="text-[10px] text-slate-400 flex items-center gap-1 uppercase">
              <Zap className="w-3 h-3 text-emerald-400" /> Total Wh
            </div>
          ...
          <div className="p-3 rounded-xl bg-slate-900/80 border border-white/5">
            <div className="text-[10px] text-slate-400 flex items-center gap-1 uppercase">
              <Activity className="w-3 h-3 text-cyan-400" /> Rendement
            </div>
          ...
          <div className="p-3 rounded-xl bg-slate-900/80 border border-white/5">
            <div className="text-[10px] text-slate-400 flex items-center gap-1 uppercase">
              <Leaf className="w-3 h-3 text-emerald-400" /> Empreinte CO₂
            </div>
        ...
        {/* Energy Chart */}
        <div className="glass-panel p-3.5 rounded-2xl mb-6 border border-emerald-500/20">
          <CanvasChart
            data={historyE}
            color="#10b981"
            unit="Wh"
